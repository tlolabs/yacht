    ...
    var body: some View {
        Form {
            Picker("Appearance", selection: $preferences.appearance) { Text("System").tag("System"); Text("Light").tag("Light"); Text("Dark").tag("Dark") }
                .accessibilityLabel("Appearance").accessibilityIdentifier("appearance")
            Toggle("Remember last-used table style", isOn: $preferences.rememberStyle)
                .accessibilityLabel("Remember last-used table style").accessibilityIdentifier("rememberStyle")
