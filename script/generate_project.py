...
icon_ref = add('icon-ref', isa='PBXFileReference', lastKnownFileType='image.icns', path='assets/icons/YACHT.icns', sourceTree='SOURCE_ROOT')
...
app_configs=configs('app', {'PRODUCT_NAME':'YACHT', 'EXECUTABLE_NAME':'YachtApp', 'PRODUCT_MODULE_NAME':'YachtNativeApp', 'PRODUCT_BUNDLE_IDENTIFIER':'com.local.yacht.csvhtmltranslator', 'INFOPLIST_FILE':'platform/macos/Support/Info.plist', 'LD_RUNPATH_SEARCH_PATHS':['$(inherited)', '@executable_path/../Frameworks']})
