...
product_app = add('product-app', isa='PBXFileReference', explicitFileType='wrapper.application', path='Y.A.C.H.T..app', sourceTree='BUILT_PRODUCTS_DIR')
...
base = {'ARCHS':'$(ARCHS_STANDARD)', 'MACOSX_DEPLOYMENT_TARGET':'14.0', 'SDKROOT':'macosx', 'SWIFT_VERSION':'6.0', 'CLANG_ENABLE_MODULES':'YES', 'CODE_SIGN_IDENTITY':'-', 'CODE_SIGN_STYLE':'Manual', 'ENABLE_HARDENED_RUNTIME':'YES', 'SWIFT_STRICT_CONCURRENCY':'complete', 'SUPPORTED_PLATFORMS':'macosx'}
project_configs=configs('project',base)
app_configs=configs('app', {'PRODUCT_NAME':'Y.A.C.H.T.', 'EXECUTABLE_NAME':'YachtApp', 'PRODUCT_MODULE_NAME':'YachtNativeApp', 'PRODUCT_BUNDLE_IDENTIFIER':'com.local.yacht.csvhtmltranslator', 'INFOPLIST_FILE':'Support/Info.plist', 'LD_RUNPATH_SEARCH_PATHS':['$(inherited)', '@executable_path/../Frameworks']})
...
add('app', isa='PBXNativeTarget', buildConfigurationList=app_configs, buildPhases=phases['app'], buildRules=[], dependencies=[], name='Yacht', productName='Y.A.C.H.T.', productReference=product_app, productType='com.apple.product-type.application', packageProductDependencies=[core_product])
...
<BuildAction parallelizeBuildables="YES" buildImplicitDependencies="YES"><BuildActionEntries><BuildActionEntry buildForTesting="YES" buildForRunning="YES" buildForProfiling="YES" buildForArchiving="YES" buildForAnalyzing="YES">{buildable(app_id,'Y.A.C.H.T..app')}</BuildActionEntry></BuildActionEntries></BuildAction>
...
<LaunchAction buildConfiguration="Debug" selectedDebuggerIdentifier="Xcode.DebuggerFoundation.Debugger.LLDB" selectedLauncherIdentifier="Xcode.IDEFoundation.Launcher.LLDB" launchStyle="0" useCustomWorkingDirectory="NO" ignoresPersistentStateOnLaunch="NO" debugDocumentVersioning="YES" debugServiceExtension="internal" allowLocationSimulation="YES"><BuildableProductRunnable runnableDebuggingMode="0">{buildable(app_id,'Y.A.C.H.T..app')}</BuildableProductRunnable></LaunchAction>
<ProfileAction buildConfiguration="Release" shouldUseLaunchSchemeArgsEnv="YES" useCustomWorkingDirectory="NO" debugDocumentVersioning="YES"><BuildableProductRunnable runnableDebuggingMode="0">{buildable(app_id,'Y.A.C.H.T..app')}</BuildableProductRunnable></ProfileAction>
